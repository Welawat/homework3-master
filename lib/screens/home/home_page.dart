...
import 'package:homework3/models/todo_item.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Text('Albums ID: '+ todoItem.userId.toString(),style: TextStyle(
                                          fontSize: 12.0,
                                        )),
                                      ),
                                      SizedBox(width: 10.0,),
                                      Container(
                                        ...
                                        child: Text('User ID: '+ todoItem.id.toString(),style: TextStyle(
                                          fontSize: 12.0,
                                        ),),
                                      ),
                                    ],
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text('Photo Albums'),centerTitle: true,
        ),body: body);
  }
}